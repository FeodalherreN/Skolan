...
public:
	...
	Iterator operator+(int rhs){ Iterator i = *this; i.data += rhs; return i; }
...
public:
	...
	Const_Iterator operator+(const int rhs){ Const_Iterator i = *this; i.data += rhs; return i; }
...
public:
	...
	Reverse_Iterator operator+(int rhs){ Reverse_Iterator i = *this; i.data -= rhs; return i; }
	char& operator[](int index){ return *(data - index); }
	char* operator->() { return data; }
...
public:
	...
	Const_Reverse_Iterator& operator=(char* rhs){ data = rhs; return *this; }
	Const_Reverse_Iterator& operator=(Const_Reverse_Iterator& rhs){ data = rhs.data; return *this; }
	...
	Const_Reverse_Iterator operator+(const int rhs){ Const_Reverse_Iterator i = *this; i.data -= rhs; return i; }
	char& operator*() { return *data; }
	const char* operator->() { return data; }
	const char& operator[](const int index){ return *(data - index); }
