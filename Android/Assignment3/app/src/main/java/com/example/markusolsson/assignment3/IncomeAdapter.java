...
public class IncomeAdapter {
    ...
    public static final String MYDATABASE_TABLE = "incomes";
    ...
    public IncomeAdapter openToRead() throws android.database.SQLException {
        sqLiteHelper = new SQLiteHelper(context, MYDATABASE_NAME, null, MYDATABASE_VERSION);
        sqLiteDatabase = sqLiteHelper.getReadableDatabase();
        return this;
    }

    public IncomeAdapter openToWrite() throws android.database.SQLException {
        sqLiteHelper = new SQLiteHelper(context, MYDATABASE_NAME, null, MYDATABASE_VERSION);
    ...
    public long insert(String title, int Amount) {
        ...
        return sqLiteDatabase.insert("incomes", null, contentValues);
    }
    ...
    {
        Cursor x = sqLiteDatabase.rawQuery("SELECT SUM(amount) FROM incomes;", null);
        return x;
    }
